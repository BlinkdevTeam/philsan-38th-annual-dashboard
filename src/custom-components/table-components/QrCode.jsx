        ...
        <>
        {
            ...
            <div className="">
                ...
                <div className="flex h-[100vh] justify-center items-center">
                    <div ref={elementRef} className="relative overflow-hidden rounded-xl w-[400px] h-[740px] bg-white">
                        ...
                        <div className="w-[100%] flex flex-col items-center text-center z-[2] justify-center w-full overflow-visible relative">
                            <div className="z-[1]">
                            ...
                            <div className="w-[100%] flex justify-center">
                                ...
                                <img
                                    className="w-[200px]"
                                    src={`https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${eValue}`}
                                    alt=""
                                />
                                </div>
                            </div>

                            <div className="w-[100%] absolute bottom-[0px]">
                                <img
                            ...
                            <div className="absolute bottom-[0px] w-[110%] flex justify-center items-center pointer-events-none z-[1]">
                            <img
                                ...
                                className="w-full max-w-none h-auto opacity-[.5]"
                            />
                            </div>
                        </div>
                    </div>
