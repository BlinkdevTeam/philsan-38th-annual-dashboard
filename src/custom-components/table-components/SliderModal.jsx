...
const SliderModal = (props) => {
    ...
    return (
        <>
            <div className={`overflow-y-scroll ${ props.selectedCol ? "w-[90%] lg:w-[60%]" : "w-[0px]"} bg-[#dce4df] absolute top-[0px] right-[0px] transition-all duration-200 ease z-[99] scrollbar-none `}>
                <div className="h-[100vh]">
                    <div className="py-[40px] px-[30px] lg:py-[40px] lg:px-[50px]">
                        <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center mb-[30px] lg:mb-[50px]">
                            <div className="cursor-pointer flex gap-[20px] items-center" onClick={props.closeModal}>
                                <svg className="w-[16px] h-[14px]" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <h6 className="text-[#67706a] text-[16px] lg:text-[18px]">Participant Details</h6>
                            </div>
                        </div>
                        <div className="flex gap-[20px] lg:gap-[50px]">
                            <div className="flex flex-col gap-[20px] w-[45px] md:w-[240px] h-fit md:mt-[20px]">

                                {/*Approve, delete and cancel */}
                                <div className="flex flex-col gap-[5px] lg:gap-[20px]">
                                    <div className="">
                                        {/* <div onClick={handleApprove} className="justify-center md:justify-start flex gap-[10px] items-center px-[10px] md:px-[20px] py-[10px] rounded-[8px] bg-[#98d3ab] hover:bg-[#1f783b] cursor-pointer transition-background-color duration-300 ease-in-out"> */}
                                            ...
                                            <svg className="w-[15px] lg:w-[18px] h-[10px] lg:h-[13px]" viewBox="0 0 18 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <p className="hidden md:block text-[#f9f9f9] text-[12px] lg:text-[16px]">Accept</p>
                                        </div>
                                    </div>
                                    <div className="relative">
                                        {/* <div onClick={() => handlePopup("cancel")} className={`justify-center md:justify-start flex gap-[10px] items-center px-[10px] md:px-[20px] py-[10px] rounded-[8px] ${isCancelRemarksOpen ? "bg-[#797979]" : "bg-[#98d3ab] hover:bg-[#424242]"} cursor-pointer transition-background-color duration-300 ease-in-out`}> */}
                                            <div className={`justify-center md:justify-start flex gap-[10px] items-center px-[10px] md:px-[20px] py-[10px] rounded-[8px] ${isCancelRemarksOpen ? "bg-[#797979]" : "bg-[#98d3ab] hover:bg-[#424242]"} cursor-pointer transition-background-color duration-300 ease-in-out`}>
                                            <svg className="w-[15px] lg:w-[18px] h-[10px] lg:h-[13px]" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M13 1L1 13M13 13L1 1.00001" stroke="#ffffff" strokeWidth="2" strokeLinecap="round"/>
                                            </svg>
                                            <p className="hidden md:block text-[#f9f9f9] text-[12px] lg:text-[16px]">Cancel</p>
                                        </div>
                                    ...
                                    <div className="relative">
                                        {/* <div onClick={() => handlePopup("delete")} className={`justify-center md:justify-start flex gap-[10px] items-center px-[10px] md:px-[20px] py-[10px] rounded-[8px] ${isDeleteRamarksOpen ? "bg-[#ba4b4b]" : "bg-[#98d3ab] hover:bg-[#ba4b4b]"} cursor-pointer transition-background-color duration-300 ease-in-out`}> */}
                                            <div className={`justify-center md:justify-start flex gap-[10px] items-center px-[10px] md:px-[20px] py-[10px] rounded-[8px] ${isDeleteRamarksOpen ? "bg-[#ba4b4b]" : "bg-[#98d3ab] hover:bg-[#ba4b4b]"} cursor-pointer transition-background-color duration-300 ease-in-out`}>
                                            ...
                                            <p className="hidden md:block text-[#f9f9f9] text-[12px] lg:text-[16px]">Delete</p>
                                        </div>
                                ...
                                <div className="flex flex-col gap-[5px] lg:gap-[20px] pt-[20px]">
                                    <div className="">
                                        {/* <div onClick={() => props.handleTime({action: "time-in"})} className="justify-center md:justify-start flex gap-[10px] items-center px-[10px] md:px-[20px] py-[10px] rounded-[8px] bg-[#98d3ab] hover:bg-[#1f783b] cursor-pointer transition-background-color duration-300 ease-in-out"> */}
                                          <div className="justify-center md:justify-start flex gap-[10px] items-center px-[10px] md:px-[20px] py-[10px] rounded-[8px] bg-[#98d3ab] hover:bg-[#1f783b] cursor-pointer transition-background-color duration-300 ease-in-out">
                                            <svg className="w-[20px] lg:w-[25px] h-[20px] lg:h-[25px]" clipRule="evenodd" fillRule="evenodd" stroke-linejoin="round" stroke-miterlimit="2" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <p className="hidden md:block text-[#f9f9f9] text-[12px] lg:text-[16px]">Time-In</p>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        {/* <div onClick={() => props.handleTime({action: "time-out"})} className="justify-center md:justify-start flex gap-[10px] items-center px-[10px] md:px-[20px] py-[10px] rounded-[8px] bg-[#98d3ab] hover:bg-[#424242] cursor-pointer transition-background-color duration-300 ease-in-out"> */}
                                          <div className="justify-center md:justify-start flex gap-[10px] items-center px-[10px] md:px-[20px] py-[10px] rounded-[8px] bg-[#98d3ab] hover:bg-[#424242] cursor-pointer transition-background-color duration-300 ease-in-out">
                                            ...
                                            <p className="hidden md:block text-[#f9f9f9] text-[12px] lg:text-[16px]">Time-Out</p>
                                        </div>
                                    </div>
                                    <div>
                                        {/* <div onClick={() => props.handleTime({action: "delete-timein"})} className="justify-center md:justify-start flex gap-[10px] items-center px-[10px] md:px-[20px] py-[10px] rounded-[8px] bg-[#98d3ab] hover:bg-[#ba4b4b] cursor-pointer transition-background-color duration-300 ease-in-out"> */}
                                            ...
                                            <p className="hidden md:block text-[#f9f9f9] text-[12px] lg:text-[16px]">Delete Time-In</p>
                                        </div>
                                    </div>
                                    <div>
                                        {/* <div onClick={() => props.handleTime({action: "delete-timeout"})} className="justify-center md:justify-start flex gap-[10px] items-center px-[10px] md:px-[20px] py-[10px] rounded-[8px] bg-[#98d3ab] hover:bg-[#ba4b4b] cursor-pointer transition-background-color duration-300 ease-in-out"> */}
                                            ...
                                            <p className="hidden md:block text-[#f9f9f9] text-[12px] lg:text-[16px]">Delete Time-Out</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
