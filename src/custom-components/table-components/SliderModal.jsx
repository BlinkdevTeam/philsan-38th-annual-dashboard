                        ...
                        <div className="flex justify-between items-center mb-[50px]">
                            ...
                            { props.sponsor.name === "Philsan Secretariat" &&
                                <div className="flex gap-[20px]">
                                    <div onClick={() => props.onApprove()} className="flex gap-[10px] items-center px-[20px] py-[10px] rounded-[8px] bg-[#acc5b4] hover:bg-[#1f783b] cursor-pointer transition-background-color duration-300 ease-in-out">
