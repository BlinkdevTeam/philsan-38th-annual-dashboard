...
const MainTable = ({sponsor}) => {
    ...
    return (
        <div>
            ...
            <div className="flex">
                <div className="sidebar flex flex-col justify-between w-[400px] h-[100vh] overflow-y-scroll scrollbar-none">
                                ...
                                <div className="px-[20px] pb-[20px]">
                                    <div className="flex flex-col gap-[2px]">
                                        ...
                                        <SponsorWidget
                                            ...
                                            color={"text-[#f9b700]"}
                                            userStatus={userStatus}
                                            setUserStatus={() => setContent("Approved", "Non-Sponsored", null)}
                                        /> 
                                    </div>
                                </div>
                                <div className="px-[20px] pb-[20px]">
                                ...
                                <div className="h-[450px] pl-[20px] pr-[5px] mr-[20px] overflow-y-scroll overflow-x-hidden scrollbar-custom">
                                    <div className="flex flex-col gap-[2px]">
                                        {   
                                            ...
                                            .map((item, index) => (
                                                <div className="flex w-[100%] items-center gap-[5px] relative">
