...
const PresentationLogin = ({setSponsorIn}) => {
    ...
    const onSubmit = async () => {
        ...
        if (emailExist) {
            navigate(`/speaker-presentation/${emailExist[0].email}`) 
        }
    }
    ...
    return (
        <div className="w-[100%]">
            <div className="w-[100%] md:max-w-[1200] mx-auto">
                <div className="flex justify-center">
                    <div className="w-[100%] flex justify-center items-center h-[100vh]">
                        <div className="flex flex-col gap-[20px] mt-[-100px] w-[100%] md:w-fit">
                            <div className="flex flex-col justify-start items-center pb-[10px]">
                                ...
                                <div className="pt-[40px]">
                                    <h6 className="text-[#1f783b] text-[18px] md:text-[26px] font-[1000] mt-[-5px]">SPEAKER PRESENTATION</h6>
                                </div>
                            </div>
                            <div className="bg-[#ffffff] px-[30px] pb-[60px] rounded-lg shadow-md">
                                <div className="flex flex-col gap-[10px]">
                                    <div className="flex flex-col gap-[5px] w-[100%] md:w-[350px]">
                                        <h6 className="font-[700] text-[#1f783b]">Enter Email Address</h6>
                                        <input onChange={(e) => setEmail(e.target.value)} className="bg-[#eaeeeb] p-[10px] rounded-md w-[100%]" type="text" placeholder="Email Address" />
                                    </div>
