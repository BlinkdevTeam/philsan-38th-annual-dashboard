...
const QuizorSurvey = () => {
    ...
    const handleDownload = async () => {
        const fullName = formatName(participant.first_name, participant.last_name)
                ...
                <div className="max-w-[1200] mx-auto">
                    <div className="flex">
                        <div className=" w-[100%] flex flex-col justify-center items-center h-[100vh]">
                            <div className="flex flex-col w-[90%] md:w-[780px] gap-[20px] mt-[-175px] items-center">
